...
(
	...
	`kampanya_adi` nvarchar(50) NULL,
	`kampanya_logo` nvarchar(50) NULL,
	`kampanya_aciklama` nvarchar(50) NULL,
	`kampanya_baslangic_tarihi` datetime NULL,
	`kampanya_bitis_tarihi` datetime NULL,
	`pasif` varchar(20) NULL,
     PRIMARY KEY (`id`)
